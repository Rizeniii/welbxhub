...
function Update:Window(Config)
	...
	local WelbXHub = Instance.new("ScreenGui");
	WelbXHub.Name = "WelbXHub";
	WelbXHub.Parent = game.CoreGui;
	WelbXHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = WelbXHub;
